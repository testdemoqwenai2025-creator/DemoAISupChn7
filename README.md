...
<img src="https://img.shields.io/badge/Status-Live_24%2F7_365-brightgreen?style=for-the-badge" alt="Live 24/7 365" />
<img src="https://img.shields.io/badge/Access-Open_No_NDA_Required-blue?style=for-the-badge" alt="No NDA Required" />
<img src="https://img.shields.io/badge/GDPR-Compliant-success?style=for-the-badge" alt="GDPR Compliant" />
<img src="https://img.shields.io/badge/Type-Enterprise_SaaS-informational?style=for-the-badge" alt="Enterprise SaaS" />

<br />
<br />

# AI Supply Chain Advanced
### Enterprise Intelligence Platform — Public Demo

**AI-powered supply chain intelligence, real-time risk monitoring, regulatory compliance automation, and predictive analytics for global enterprises.**
...
| **Login** | ❌ No — demo mode, no credentials needed |
...
AI Supply Chain Advanced is a next-generation enterprise intelligence platform that transforms how organisations monitor, analyse, and respond to supply chain dynamics across global markets. Built on advanced AI/ML models, the platform delivers real-time actionable intelligence to decision-makers in finance, manufacturing, agriculture, energy, healthcare, and government sectors.

This public demo repository contains a **client-viewable static site** — investors, startup accelerators, seed funds, and integration partners are invited to explore the full platform at their convenience, **24 hours a day, 7 days a week, 365 days a year**, with no NDA or prior registration required.
...
|----------|-----------------|
| **Investors & Seed Funds** | Market opportunity, product maturity, traction indicators |
| **Startup Accelerators** | Technology stack, scalability, team capability |
| **Enterprise Clients** | Feature set, industry verticals, deployment readiness |
| **Integration Partners** | API surface, platform architecture, compliance posture |
| **Procurement Teams** | Pricing tiers, support model, SLA framework |
...
This repository is protected by the following guardrails to ensure the demo remains stable and available 24/7:

| Guardrail | Description |
|-----------|-------------|
| **Branch Protection** | Direct pushes to `main` are blocked — all changes require pull request review |
| **Required Reviews** | At least 1 approving review required before merge |
| **Status Checks** | Pages validation workflow must pass before merge |
| **Code Ownership** | Changes require approval from designated owners (see `CODEOWNERS`) |
| **Linear History** | Merge commits are blocked — only squash/rebase merges allowed |
| **Auto-Deploy** | Every merge to `main` auto-deploys to GitHub Pages within ~60 seconds |
...
├── .nojekyll                       # Enables _next/ serving on Pages
├── index.html                      # Landing page
├── dashboard.html                  # Dashboard page
├── ... (13 more HTML pages)        # Marketing site pages
├── cc-app/                         # Next.js Command Center SPA (static export)
